		...
		<!-- Info bar end -->
		 ...
		 <div class="col-lg-9"> 
		  <div class="panel panel-primary">
			...
			<input type="hidden" id="hasheduser" value="eDkwMDBoeA==">
			<input type="hidden" id="hashedpass" value="eDkwMDBoeA==">
			...
			<!-- Challange Begin -->
			  ...
			  <form name="myForm" id="myForm" method="POST" action="<?php echo base_url();?>bootstrap/challanges/4.php">
				   ...
				   <div class="input-group">
					...
					<center>
					<button type="button" onclick="CheckThis();" class="btn btn-primary">Login</button>
					</center>
			</form>
...
<script src="<?php echo base_url();?>bootstrap/challanges/4.js"></script>
<script>
function CheckThis(){

		 ...
		 <div class="col-lg-9"> 
		  <div class="panel panel-primary">
			...
			<!-- Challange Begin -->
			  ...
			  <pre>
<font color="#0084d7">LPVOID</font> GetPointer(<font color="#0084d7">char</font> buffer)
{
	<font color="#0084d7">char</font>* mem = (<font color="#0084d7">char</font>*)malloc(100);
	<font color="#0084d7">return</font> (<font color="#0084d7">LPVOID</font>)mem;
}

<font color="#006305">// Buffer occurred when function called :</font>
<font color="#0084d7">char</font>* buff[250] = {0};
memcpy(GetPointer(),buff,sizeof(buff));
			  </pre>
			  </br>
			  
			  How could you solve this error by replacing one line ? (e.g x = hi => x = hello)</br>
			  Enter the code line :
			  </font>
			  
			  
			  <?php echo form_open('dashboard/WinChallange/' . $ChallangeInfo['chid'] . '/mainchallanges/-NULL-');?>
					  
						<input class="form-control input-sm" name = "answer" id="answer"></input></br>
		   ...
		   <a href="<?php echo base_url();?>dashboard/LoseChallange/<?php echo $ChallangeInfo['chid'] . '/mainchallanges'; ?>"><button type="button" class="btn btn-default btn-block">Quit challange</button></a>
